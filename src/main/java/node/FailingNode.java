...
public class FailingNode extends StabilizerNode {
     ...
     *           as IP:PORT
     */
    public FailingNode(int id, Consumer<LocalNode>[] tasks, String[] labels, long[] delays, long[] periods) throws NetworkFailureException {
        super(id, tasks, labels, delays, periods, null);
        hasFailed = false;
    }
    ...
    public FailingNode(int id, Node node, Consumer<LocalNode>[] tasks, String[] labels, long[] delays, long[] periods) throws  NetworkFailureException {
        super(id, node, tasks, labels, delays, periods, null);
        hasFailed = false;
    }
